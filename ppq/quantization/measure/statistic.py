...
def torch_KL_divergence(ref_hist: torch.Tensor, hist: torch.Tensor, eps=1e-30) -> float:
    ...
    return torch.dot(ref_hist.double(), torch.log10(ref_hist.double() + eps) - torch.log10(hist.double() + eps)).item()